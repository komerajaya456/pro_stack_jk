var obj = {"name":"gowtham","age":22,"id":1}
console.log(obj.id)//1
console.log(obj) //printed whole object
console.log(typeof(obj))//object
console.log(JSON.stringify(obj))//converts to string
...
console.clear()
const obj1={name:"komera",age:22,id:1}
const obj2={name:"gow",age:20,id:2}
var arr=[obj1,obj2]
//console.log(arr)
arr.push({name:"hvn"})
console.log(arr)